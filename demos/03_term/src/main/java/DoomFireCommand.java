...
public class DoomFireCommand implements Callable<Void> {
  ...
  @Option(names={"-l","--logo"},defaultValue = "../.demoit/images/devoxx-white.png")
  File logo;
    ...
    while (true) {
      ...
      for (int y = 0; y < screenHeight - 1; y = y + 2) {
        ...
        for (int x = 0; x < screenWidth; x++) {
          ...
          if (isDefaultColor(color1) && isDefaultColor(color2)&&isDefaultColor(lastColor1) && isDefaultColor(lastColor2)){
            line.append(' ');
          }else {
